    ...
    BEGIN TRY
        ...
        SELECT
            ...
            CASE
                ...
                WHEN s.orig_condition LIKE 'Women%' THEN 'Not Listed / Other'
                WHEN s.orig_condition LIKE 'Hypogonadism%' THEN 'Male Hypogonadism'
                WHEN s.orig_condition LIKE 't Care' THEN 'Topical Care'
                WHEN s.orig_condition LIKE 't Pac' THEN 'Not Listed / Other'
                WHEN s.orig_condition LIKE 'acial Lipoatrophy' THEN 'Facial Lipoatrophy'
                WHEN s.orig_condition LIKE 'acial wrinkles' THEN 'Facial Wrinkles'
                WHEN s.orig_condition LIKE 'ailure to Thrive' THEN 'Failure to Thrive'
                WHEN s.orig_condition LIKE '%users found this%' OR s.orig_condition LIKE 'min %' THEN 'Not Listed / Other'
                WHEN s.orig_condition LIKE 'mulation)%' THEN 'Not Listed / Other'
                WHEN s.orig_condition IN ('min)', 'mis', 'mist (' ) THEN 'Not Listed / Other'
                WHEN s.orig_condition LIKE 'mist %' THEN 'Not Listed / Other'
                WHEN s.orig_condition LIKE 'amilial Cold%' THEN 'Familial Cold Autoinflammatory Syndrome'
                WHEN s.orig_condition LIKE 'amilial Mediterr%' THEN 'Familial Mediterranean Fever'
                WHEN s.orig_condition LIKE 'Cance' THEN 'Cancer'
                WHEN s.orig_condition LIKE 'von Willebran%' THEN 'Von Willebrand''s Disease'
                WHEN s.orig_condition LIKE 'emale Infertility' THEN 'Female Infertility'
                WHEN s.orig_condition LIKE 'eve' THEN 'Pain'
                WHEN s.orig_condition LIKE 'Q Feve' THEN 'Q Fever'
                WHEN s.orig_condition LIKE 'moterol)' THEN 'Formoterol'
                WHEN s.orig_condition LIKE 'Gastric Cance' THEN 'Gastric Cancer'
                WHEN s.orig_condition LIKE '%mycophenolic%' THEN 'Not Listed / Other'
                WHEN s.orig_condition LIKE '%amlodipine%' THEN 'High Blood Pressure'
                WHEN s.orig_condition LIKE 'ibrocystic Breast Disease' THEN 'Fibrocystic Breast Disease'
                WHEN s.orig_condition LIKE 'lic Acid Deficiency' THEN 'Folic Acid Deficiency'
